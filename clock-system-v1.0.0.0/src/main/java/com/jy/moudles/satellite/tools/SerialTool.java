package com.jy.moudles.satellite.tools;
...
import com.jy.moudles.satellite.tools.serialException.SendDataToSerialPortFailure;
import com.jy.moudles.satellite.tools.serialException.SerialPortInputStreamCloseFailure;
import com.jy.moudles.satellite.tools.serialException.SerialPortOutputStreamCloseFailure;
import com.jy.moudles.satellite.tools.serialException.SerialPortParameterFailure;
import com.jy.moudles.satellite.tools.serialException.TooManyListeners;
...
public class SerialTool {
    ...
    public static void main(String[] args) throws NoSuchPortException, SerialPortParameterFailure, NotASerialPort, NoSuchPort, PortInUse, SendDataToSerialPortFailure, SerialPortOutputStreamCloseFailure {
		for (String port : SerialTool.findPort()) {
			System.out.println(port);
		}
		
//		SerialPort port = SerialTool.openPort("COM2", 9600);
//		SerialTool.sendToPort(port, "$GPGSV,3,2,10,20,27,286,17,29,23,059,27,06,19,176,21,23,11,318,*71".getBytes());
