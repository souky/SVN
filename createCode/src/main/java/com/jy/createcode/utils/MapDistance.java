...
public class MapDistance {
	...
	public static String getDistance(String lat1Str, String lng1Str,
		...
		double distance = patm
				* Math.asin(Math.sqrt(Math.pow(Math.sin(difference / patm),
						patm)
						+ Math.cos(radLat1)
						* Math.cos(radLat2)
	 ...
	 * 最大纬度 minLat
	 */
	public static Map<String, String> getAround(String latStr, String lngStr,
			String raidus) {
	...
	public static void main(String[] args) {
		...
		System.out.println(getDistance("116.97265", "36.694514", "116.597805",
				"36.738024"));
