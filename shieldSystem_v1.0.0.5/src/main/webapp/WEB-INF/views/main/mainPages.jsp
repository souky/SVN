...
<script type="text/javascript" src="<%=basePath%>/static/jy/js/common/jry-Plug-in.js<%=version%>"></script>
<script type="text/javascript" src="<%=basePath%>/static/jy/js/main/mainPages.js<%=version%>"></script>
</html>
