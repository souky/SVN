...
<script type="text/javascript" src="<%=basePath%>/static/common/js/bootstrap-tour.min.js"></script>
<script type="text/javascript" src="<%=basePath%>/static/common/js/jquery.tips.js"></script>
