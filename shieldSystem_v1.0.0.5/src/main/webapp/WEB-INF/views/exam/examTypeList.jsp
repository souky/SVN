	...
	<div id="newExamType" class="hide">
		...
		<div class="Jcustom_content">
			...
			<div class="Jcustom_content_items ">
				...
				<input type="text" maxlength='30' id="examTypeNo_JRY" name="examTypeNo_JRY" placeholder="请输入考试类型编号">
				<div class="error_text"></div>
			</div>
			<div class="Jcustom_content_items">
				<label>考试类型名称</label>
				<input type="text" maxlength='30' onkeyup="this.value=this.value.replace(/\s+/g,'')" id="examTypeName_JRY" name="examTypeName_JRY" placeholder="请输入考试类型名称,最长为30个字符">
				<div class="error_text"></div>
			</div>
			</form>
