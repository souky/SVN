...
public interface DeviceService {
	...
	List<String> queryMACs();

    void updateShieldListOrder(Map<String,Object> filter);

	void updateAllOnlineShield(String poweroff, String operationType);

	/**
	 * 清除屏蔽设备的listorder
	 */
	void clearListOrder(String id);

	/**
	 * 统计在线和异常屏蔽
	 */
	List<Integer> countShiledOnlinAndAbnormal();
