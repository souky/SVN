...
import com.jy.moudles.exam.util.ShieldSwitchUtils4Exam;
...
public class ExamSubController {
	...
	public AsyncResponseData.ResultData saveExsub(HttpServletRequest request){
		...
		//开启定时器,打开设备
		ShieldSwitchUtils4Exam.openTimer(exsub.getName(), exsub.getStartTime(), exsub.getEndTime());
