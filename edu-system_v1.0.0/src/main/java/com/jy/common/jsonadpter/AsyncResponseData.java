...
public final class AsyncResponseData {
    ...
    public static final int RESPONSE_STATUS_TIMEOUT = 11111;        //超时
    ...
    public static ResultData getTimeoutrror(String errMsg) {
        return new ResultData(RESPONSE_STATUS_TIMEOUT);
    }
